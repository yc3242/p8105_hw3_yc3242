...
* **[Question]** There are **`r instacart %>% distinct(aisle) %>% count()`** aisles in the dataset. 
...
instacart %>%
  ...
  mutate(order_dow = factor(days[order_dow + 1], levels = days_of_the_week)) %>% 
